...
form.csv : form.json
	json-to-multicsv.pl --file $< --path /:table:form --path /*/person_filing/:table:contact --path /*/signatures/:table:signatures --path /*/receipts/:table:receipts --path /*/schedule_disbursements/:table:schedule_disbursements --path /*/specific_activities/:table:specific_activities --path /*/specific_activities/*/performers/:table:performer --path /*/*/individual_disbursements/:table:individual_disbursements -path /*/disbursements/:table:disbursements --path /*/direct_or_indirect/:column --path /*/employer/:column --path /*/terms_and_conditions/:column
